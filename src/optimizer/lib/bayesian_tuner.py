...
from src.optimizer.lib.backtesting import (
    aggregate_cv_results,
    create_rolling_window_splits,
    forward_looking_evaluation,
)
from src.optimizer.tuning import (
...
class BayesianTuner:
    ...
    def validate_objective_weights(
        ...
        for weight_idx, weights in enumerate(weight_combinations):
            ...
            for fold_idx, (train_df, test_df) in enumerate(splits):
                ...
                # Simulate allocation on training data
                from src.optimizer.tuning import simulate_allocation
    ...
    def tune_with_pareto_analysis(
        ...
        """
        from src.optimizer.lib.pareto import (
    ...
    def compare_objective_weights(
        ...
        """
        from src.optimizer.lib.pareto import compute_pareto_frontier
