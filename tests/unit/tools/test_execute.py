...
class TestExtractMetricsFromRow:
    ...
    def test_extract_basic_metrics(self):
        ...
        from src.cli.commands.execute import _extract_metrics_from_row
...
class TestProcessResults:
    ...
    def test_process_results_basic_scaling(self):
        ...
        from src.cli.commands.execute import _process_results
...
class TestLoadData:
    ...
    def test_load_data_success(self, mock_read_csv):
        ...
        from src.cli.commands.execute import _load_data
    ...
    @patch("pandas.read_csv")
    @patch("src.cli.commands.execute.logger")
...
class TestProcessAdsets:
    ...
    @patch("src.cli.commands.execute._extract_metrics_from_row")
    def test_process_adsets_basic(self, mock_extract):
        """Test basic adset processing"""
        from src.cli.commands.execute import _process_adsets
...
class TestIntegration:
    ...
    def test_extract_and_process_pipeline(self):
        ...
        from src.cli.commands.execute import _extract_metrics_from_row, _process_results
