...
class TestBuildAggDict:
    ...
    def test_basic_aggregation(self):
        ...
        from src.adset.allocator.cli.commands.extract import _build_agg_dict
...
class TestRecalculateROASMetrics:
    ...
    def test_recalculate_revenue_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calculate_revenue_metrics
    ...
    def test_calculate_roas_comparisons(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calculate_roas_comparisons
...
class TestRollingMetrics:
    ...
    def test_calc_roas_rolling_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calc_roas_rolling_metrics
    ...
    def test_calc_spend_rolling_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calc_spend_rolling_metrics
    ...
    def test_calc_roas_std_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calc_roas_std_metrics
    ...
    def test_calc_roas_trend(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calc_roas_trend
    ...
    def test_calc_rolling_window_coverage(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calc_rolling_window_coverage
...
class TestLaggedFeatures:
    ...
    def test_create_lagged_roas_features(self):
        ...
        from src.adset.allocator.cli.commands.extract import _create_lagged_features
...
class TestBudgetMetrics:
    ...
    def test_recalculate_budget_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _recalculate_budget_metrics
...
class TestCostMetrics:
    ...
    def test_recalculate_cost_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _recalculate_cost_metrics
...
class TestEngagementMetrics:
    ...
    def test_recalculate_engagement_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _recalculate_engagement_metrics
...
class TestInteractionMetrics:
    ...
    def test_recalc_interaction_metrics(self):
        ...
        from src.adset.allocator.cli.commands.extract import _recalc_interaction_metrics
...
class TestRollingMetricsIntegration:
    ...
    def test_calculate_rolling_metrics_missing_columns(self):
        ...
        from src.adset.allocator.cli.commands.extract import _calculate_rolling_metrics
    ...
    @patch("src.adset.allocator.cli.commands.extract.logger")
